...
public class ProjectService
{
    ...
    private readonly ILogger _taskChangesLogger;

    public ProjectService(ILogger taskChangesLogger, NotificationSenderProvider notificationSenderProvider)
    {
    ...
    public void AddUserToProject(Project project, User newUser, NotificationTypes? senderType = null)
    {
